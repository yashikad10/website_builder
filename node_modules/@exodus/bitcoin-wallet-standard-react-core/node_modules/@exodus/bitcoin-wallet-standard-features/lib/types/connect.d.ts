 ...
 * @group Connect
 */
export declare type BitcoinConnectFeature = {
    /** Name of the feature. */
 ...
 * @group Connect
 */
export declare type BitcoinConnectVersion = '1.0.0';
/**
 * Method to call to use the {@link BitcoinConnectFeature}.
 *
 * @group Connect
 */
export declare type BitcoinConnectMethod = (input: BitcoinConnectInput) => Promise<BitcoinConnectOutput>;
/**
...
export declare type BitcoinAddressPurpose = 'ordinals' | 'payment';
/**
