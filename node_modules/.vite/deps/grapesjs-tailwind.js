...
// node_modules/grapesjs-tailwind/dist/grapesjs-tailwind.min.js
var require_grapesjs_tailwind_min = __commonJS({
  "node_modules/grapesjs-tailwind/dist/grapesjs-tailwind.min.js"(exports, module) {
    !function(t, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports["grapesjs-tailwind"] = e() : t["grapesjs-tailwind"] = e();
    }("undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : exports, function() {
      return function(t) {
        var e = {};
        function l(i) {
          if (e[i])
          ...
          return t[i].call(r.exports, r, r.exports, l), r.l = true, r.exports;
        }
        return l.m = t, l.c = e, l.d = function(t2, e2, i) {
          l.o(t2, e2) || Object.defineProperty(t2, e2, { enumerable: true, get: i });
        }, l.r = function(t2) {
          "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t2, "__esModule", { value: true });
        }, l.t = function(t2, e2) {
          if (1 & e2 && (t2 = l(t2)), 8 & e2)
            return t2;
          if (4 & e2 && "object" == typeof t2 && t2 && t2.__esModule)
            return t2;
          var i = /* @__PURE__ */ Object.create(null);
          if (l.r(i), Object.defineProperty(i, "default", { enumerable: true, value: t2 }), 2 & e2 && "string" != typeof t2)
            for (var r in t2)
              l.d(i, r, (function(e3) {
                return t2[e3];
              }).bind(null, r));
        ...
        function l(t2, e2, l2, i, r, a, s) {
          try {
            var o = t2[a](s), n = o.value;
          } catch (t3) {
            return void l2(t3);
          }
          o.done ? e2(n) : Promise.resolve(n).then(i, r);
        }
        ...
        t.exports = function(t2, e2, l) {
          return e2 in t2 ? Object.defineProperty(t2, e2, { value: l, enumerable: true, configurable: true, writable: true }) : t2[e2] = l, t2;
        }, t.exports["default"] = t.exports, t.exports.__esModule = true;
      }, function(t, e, l) {
        var i = function(t2) {
          "use strict";
          var e2, l2 = Object.prototype, i2 = l2.hasOwnProperty, r = "function" == typeof Symbol ? Symbol : {}, a = r.iterator || "@@iterator", s = r.asyncIterator || "@@asyncIterator", o = r.toStringTag || "@@toStringTag";
          function n(t3, e3, l3) {
            return Object.defineProperty(t3, e3, { value: l3, enumerable: true, configurable: true, writable: true }), t3[e3];
          }
          try {
            n({}, "");
          } catch (t3) {
          ...
          function c(t3, e3, l3, i3) {
            var r2 = e3 && e3.prototype instanceof m ? e3 : m, a2 = Object.create(r2.prototype), s2 = new j(i3 || []);
            return a2._invoke = /* @__PURE__ */ function(t4, e4, l4) {
              var i4 = h;
              return function(r3, a3) {
                ...
                for (l4.method = r3, l4.arg = a3; 1; ) {
                  ...
                  if ("next" === l4.method)
                    l4.sent = l4._sent = l4.arg;
                  else if ("throw" === l4.method) {
                    if (i4 === h)
                      throw i4 = f, l4.arg;
                    l4.dispatchException(l4.arg);
                  } else
                    "return" === l4.method && l4.abrupt("return", l4.arg);
                  i4 = g;
                  var n2 = d(t4, e4, l4);
                  if ("normal" === n2.type) {
                    if (i4 = l4.done ? f : x, n2.arg === p)
                      continue;
                    return { value: n2.arg, done: l4.done };
                  }
                  "throw" === n2.type && (i4 = f, l4.method = "throw", l4.arg = n2.arg);
                }
              };
            }(t3, l3, s2), a2;
          }
          function d(t3, e3, l3) {
            try {
              return { type: "normal", arg: t3.call(e3, l3) };
            } catch (t4) {
              return { type: "throw", arg: t4 };
            }
          }
          t2.wrap = c;
          var h = "suspendedStart", x = "suspendedYield", g = "executing", f = "completed", p = {};
          function m() {
          }
          function u() {
          }
          ...
          var y = Object.getPrototypeOf, b = y && y(y(z([])));
          b && b !== l2 && i2.call(b, a) && (w = b);
          ...
          function C(t3, e3) {
            var l3;
            this._invoke = function(r2, a2) {
              function s2() {
                return new e3(function(l4, s3) {
                  !function l5(r3, a3, s4, o2) {
                    var n2 = d(t3[r3], t3, a3);
                    if ("throw" !== n2.type) {
                      var c2 = n2.arg, h2 = c2.value;
                      return h2 && "object" == typeof h2 && i2.call(h2, "__await") ? e3.resolve(h2.__await).then(function(t4) {
                        l5("next", t4, s4, o2);
                      }, function(t4) {
                        l5("throw", t4, s4, o2);
              ...
              return l3 = l3 ? l3.then(s2, s2) : s2();
            };
          }
          function E(t3, l3) {
            var i3 = t3.iterator[l3.method];
            if (i3 === e2) {
              if (l3.delegate = null, "throw" === l3.method) {
                if (t3.iterator["return"] && (l3.method = "return", l3.arg = e2, E(t3, l3), "throw" === l3.method))
                  return p;
                l3.method = "throw", l3.arg = new TypeError("The iterator does not provide a 'throw' method");
              }
              return p;
            }
            var r2 = d(i3, t3.iterator, l3.arg);
            if ("throw" === r2.type)
              return l3.method = "throw", l3.arg = r2.arg, l3.delegate = null, p;
            var a2 = r2.arg;
            return a2 ? a2.done ? (l3[t3.resultName] = a2.value, l3.next = t3.nextLoc, "return" !== l3.method && (l3.method = "next", l3.arg = e2), l3.delegate = null, p) : a2 : (l3.method = "throw", l3.arg = new TypeError("iterator result is not an object"), l3.delegate = null, p);
          }
          function M(t3) {
            var e3 = { tryLoc: t3[0] };
          ...
          function z(t3) {
            if (t3) {
              ...
              if ("function" == typeof t3.next)
                return t3;
              if (!isNaN(t3.length)) {
                var r2 = -1, s2 = function l4() {
                  for (; ++r2 < t3.length; )
                    if (i2.call(t3, r2))
                      return l4.value = t3[r2], l4.done = false, l4;
                  return l4.value = e2, l4.done = true, l4;
                };
                return s2.next = s2;
              }
            }
          ...
          return u.prototype = v, n(k, "constructor", v), n(v, "constructor", u), u.displayName = n(v, o, "GeneratorFunction"), t2.isGeneratorFunction = function(t3) {
            var e3 = "function" == typeof t3 && t3.constructor;
            return !!e3 && (e3 === u || "GeneratorFunction" === (e3.displayName || e3.name));
          }, t2.mark = function(t3) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t3, v) : (t3.__proto__ = v, n(t3, o, "GeneratorFunction")), t3.prototype = Object.create(k), t3;
          }, t2.awrap = function(t3) {
            return { __await: t3 };
          }, A(C.prototype), n(C.prototype, s, function() {
            return this;
          }), t2.AsyncIterator = C, t2.async = function(e3, l3, i3, r2, a2) {
            void 0 === a2 && (a2 = Promise);
            var s2 = new C(c(e3, l3, i3, r2), a2);
            return t2.isGeneratorFunction(l3) ? s2 : s2.next().then(function(t3) {
              return t3.done ? t3.value : s2.next();
            });
          }, A(k), n(k, o, "Generator"), n(k, a, function() {
            return this;
            ...
            for (var l3 in t3)
              e3.push(l3);
            return e3.reverse(), function l4() {
              for (; e3.length; ) {
                var i3 = e3.pop();
                if (i3 in t3)
                  return l4.value = i3, l4.done = false, l4;
              }
              return l4.done = true, l4;
            };
          }, t2.values = z, j.prototype = { constructor: j, reset: function(t3) {
            if (this.prev = 0, this.next = 0, this.sent = this._sent = e2, this.done = false, this.delegate = null, this.method = "next", this.arg = e2, this.tryEntries.forEach(F), !t3)
              for (var l3 in this)
                "t" === l3.charAt(0) && i2.call(this, l3) && !isNaN(+l3.slice(1)) && (this[l3] = e2);
          }, stop: function() {
            this.done = true;
            ...
            var l3 = this;
            function r2(i3, r3) {
              return o2.type = "throw", o2.arg = t3, l3.next = i3, r3 && (l3.method = "next", l3.arg = e2), !!r3;
            }
            for (var a2 = this.tryEntries.length - 1; a2 >= 0; --a2) {
              var s2 = this.tryEntries[a2], o2 = s2.completion;
              if ("root" === s2.tryLoc)
                return r2("end");
              if (s2.tryLoc <= this.prev) {
                var n2 = i2.call(s2, "catchLoc"), c2 = i2.call(s2, "finallyLoc");
                if (n2 && c2) {
                  if (this.prev < s2.catchLoc)
                    return r2(s2.catchLoc, true);
                  if (this.prev < s2.finallyLoc)
                    return r2(s2.finallyLoc);
                } else if (n2) {
                  if (this.prev < s2.catchLoc)
                    return r2(s2.catchLoc, true);
                } else {
            ...
            for (var l3 = this.tryEntries.length - 1; l3 >= 0; --l3) {
              var r2 = this.tryEntries[l3];
              if (r2.tryLoc <= this.prev && i2.call(r2, "finallyLoc") && this.prev < r2.finallyLoc) {
                var a2 = r2;
                break;
              }
            }
            a2 && ("break" === t3 || "continue" === t3) && a2.tryLoc <= e3 && e3 <= a2.finallyLoc && (a2 = null);
            var s2 = a2 ? a2.completion : {};
            return s2.type = t3, s2.arg = e3, a2 ? (this.method = "next", this.next = a2.finallyLoc, p) : this.complete(s2);
          }, complete: function(t3, e3) {
            if ("throw" === t3.type)
              throw t3.arg;
            return "break" === t3.type || "continue" === t3.type ? this.next = t3.arg : "return" === t3.type ? (this.rval = this.arg = t3.arg, this.method = "return", this.next = "end") : "normal" === t3.type && e3 && (this.next = e3), p;
          }, finish: function(t3) {
            for (var e3 = this.tryEntries.length - 1; e3 >= 0; --e3) {
              var l3 = this.tryEntries[e3];
              if (l3.finallyLoc === t3)
                return this.complete(l3.completion, l3.afterLoc), F(l3), p;
            }
          }, catch: function(t3) {
            for (var e3 = this.tryEntries.length - 1; e3 >= 0; --e3) {
              var l3 = this.tryEntries[e3];
              if (l3.tryLoc === t3) {
                var i3 = l3.completion;
                if ("throw" === i3.type) {
                  var r2 = i3.arg;
                  F(l3);
                }
          ...
          }, delegateYield: function(t3, l3, i3) {
            return this.delegate = { iterator: z(t3), resultName: l3, nextLoc: i3 }, "next" === this.method && (this.arg = e2), p;
          } }, t2;
        }(1 ? t.exports : void 0);
        try {
        ...
        function y(t2) {
          for (var e2 = 1; e2 < arguments.length; e2++) {
            var l2 = null != arguments[e2] ? arguments[e2] : {};
            e2 % 2 ? w(Object(l2), true).forEach(function(e3) {
              s()(t2, e3, l2[e3]);
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(l2)) : w(Object(l2)).forEach(function(e3) {
              Object.defineProperty(t2, e3, Object.getOwnPropertyDescriptor(l2, e3));
            });
          }
          return t2;
        }
        e["default"] = function(t2) {
          var e2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l2 = y(y({}, { i18n: {}, tailwindPlayCdn: "https://cdn.tailwindcss.com", plugins: [], config: {}, cover: ".object-cover { filter: sepia(1) hue-rotate(190deg) opacity(.46) grayscale(.7) !important; }", changeThemeText: "Change Theme", openCategory: "Blog" }), e2);
          g(t2, l2), v(t2, l2), t2.I18n && t2.I18n.addMessages(y({ en: c }, l2.i18n));
          var i2 = function() {
            var t3 = r()(n.a.mark(function t4(e3) {
              var i3, r2, a2, s2, o2, c2, d2, h2, x2;
              return n.a.wrap(function(t5) {
                for (; 1; )
                  switch (t5.prev = t5.next) {
                    ...
                    case 3:
                      r2 = l2.tailwindPlayCdn, a2 = l2.plugins, s2 = l2.config, o2 = l2.cover, c2 = function() {
                        i3.contentWindow.tailwind.config = s2;
                      }, (d2 = document.createElement("script")).src = r2 + (a2.length ? "?plugins=".concat(a2.join()) : ""), d2.onload = c2, (h2 = document.createElement("style")).innerHTML = o2, x2 = setInterval(function() {
                        var t6 = i3.contentDocument;
                        t6 && t6.readyState && "complete" === t6.readyState && (t6.head.appendChild(d2), t6.head.appendChild(h2), clearInterval(x2));
                      }, 100);
                    case 11:
                    case "end":
                      return t5.stop();
          ...
          t2.Canvas.getModel()["on"]("change:frames", function(t3, e3) {
...
export default require_grapesjs_tailwind_min();
/*! Bundled license information:

grapesjs-tailwind/dist/grapesjs-tailwind.min.js:
  (*! grapesjs-tailwind - 1.0.11 *)
*/
//# sourceMappingURL=grapesjs-tailwind.js.map
