...
var prettyPrint_1 = require("./clarity/prettyPrint");
...
function principal(address) {
    const [addr, name] = address.split('.');
    return name ? (0, clarity_1.contractPrincipalCV)(addr, name) : (0, clarity_1.standardPrincipalCV)(addr);
}
exports.principal = principal;
exports.address = principal;
