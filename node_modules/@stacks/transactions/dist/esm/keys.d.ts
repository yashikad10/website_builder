...
export declare function publicKeyFromSignatureVrs(messageHash: string, messageSignature: MessageSignature | StructuredDataSignature, pubKeyEncoding?: PubKeyEncoding): string;
export declare function publicKeyFromSignatureRsv(messageHash: string, messageSignature: MessageSignature | StructuredDataSignature, pubKeyEncoding?: PubKeyEncoding): string;
