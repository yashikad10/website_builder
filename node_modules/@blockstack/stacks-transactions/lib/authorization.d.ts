...
import { AuthType, PubKeyEncoding, SingleSigHashMode, MultiSigHashMode, StacksMessageType } from './constants';
...
export declare function createTransactionAuthField(contents: TransactionAuthFieldContents): TransactionAuthField;
